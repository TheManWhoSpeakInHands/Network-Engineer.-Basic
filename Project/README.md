...
**Core Layer** - подразумевает, что на 1 устройство в среднем ляжет не более 80% от общего трафика всего предприятия.(но может и под 100% и это будет тоже нормально)
